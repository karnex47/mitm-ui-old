...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    '/System/Library/Frameworks/Python.framework/Versions/2.7/bin',
    'default_mod_dir':    '/Library/Python/2.7/site-packages',
    'default_sip_dir':    '/usr/local/share/sip',
    'deployment_target':  '10.11',
    'platform':           'macx-g++',
    'py_conf_inc_dir':    '/System/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7',
    'py_inc_dir':         '/System/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7',
    'py_lib_dir':         '/System/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/config',
    'py_version':         0x02070a,
    'qt_framework':       0,
    'sip_bin':            '/usr/local/Cellar/sip/4.17/bin/sip',
    'sip_config_args':    '--deployment-target=10.11 --destdir=/usr/local/Cellar/sip/4.17/lib/python2.7/site-packages --bindir=/usr/local/Cellar/sip/4.17/bin --incdir=/usr/local/Cellar/sip/4.17/include --sipdir=/usr/local/share/sip',
    'sip_inc_dir':        '/usr/local/Cellar/sip/4.17/include',
    'sip_mod_dir':        '/usr/local/Cellar/sip/4.17/lib/python2.7/site-packages',
