...
_pkg_config = {
    'pyqt_bin_dir':      '/usr/local/Cellar/python/2.7.11/Frameworks/Python.framework/Versions/2.7/bin',
    'pyqt_config_args':  '--qmake /usr/local/Cellar/qt5/5.5.1_2/bin/qmake --sip /usr/local/Cellar/python/2.7.11/Frameworks/Python.framework/Versions/2.7/bin/sip',
    'pyqt_mod_dir':      '/usr/local/Cellar/python/2.7.11/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtMultimedia QtNetwork QtDeclarative QtScript QtScriptTools QtXml QtOpenGL QtSql QtSvg QtTest QtWebKit QtXmlPatterns QtDesigner',
    'pyqt_sip_dir':      '/usr/local/Cellar/python/2.7.11/Frameworks/Python.framework/Versions/2.7/bin/sip',
    'pyqt_sip_flags':    '-x VendorID -t WS_MACX -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_5_0_0 -x Py_v3 -g',
    'pyqt_version':      0x040b04,
    'pyqt_version_str':  '4.11.4',
    'qt_archdata_dir':   '/usr/local/Cellar/qt5/5.5.1_2',
    'qt_data_dir':       '/usr/local/Cellar/qt5/5.5.1_2',
    'qt_dir':            '/usr/local/Cellar/qt5/5.5.1_2',
    'qt_edition':        'free',
    'qt_framework':      1,
    'qt_inc_dir':        '/usr/local/Cellar/qt5/5.5.1_2/include',
    'qt_lib_dir':        '/usr/local/Cellar/qt5/5.5.1_2/lib',
    'qt_threaded':       1,
    'qt_version':        0x050501,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'CHK_DIR_EXISTS':           '',
    'CONFIG':                   'app_bundle incremental global_init_link_order lib_version_first plugin_no_soname clang_pch_style',
    'COPY':                     '',
    'CXX':                      'clang++',
    'CXXFLAGS':                 '-pipe',
    'CXXFLAGS_APP':             '-fPIC',
    ...
    'INCDIR_QT':                '/usr/local/Cellar/qt5/5.5.1_2/include',
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                '/usr/local/Cellar/qt5/5.5.1_2/lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    'LIBS_CORE':                '',
    ...
    'MKDIR':                    '',
    'MOC':                      '/usr/local/Cellar/qt5/5.5.1_2/bin/moc',
    'RANLIB':                   'ranlib -s',
    'RPATH':                    '',
    'STRIP':                    ''
}
